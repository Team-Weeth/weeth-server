...
enum class BoardResponseCode(
    ...
    BOARD_CREATED_SUCCESS(1300, HttpStatus.OK, "게시판이 성공적으로 생성되었습니다."),
    ...
    BOARD_UPDATED_SUCCESS(1307, HttpStatus.OK, "게시판이 성공적으로 수정되었습니다."),
    BOARD_DELETED_SUCCESS(1308, HttpStatus.OK, "게시판이 성공적으로 삭제되었습니다."),
    BOARD_FIND_ALL_SUCCESS(1309, HttpStatus.OK, "게시판 목록이 성공적으로 조회되었습니다."),
    BOARD_FIND_BY_ID_SUCCESS(1310, HttpStatus.OK, "게시판이 성공적으로 조회되었습니다."),
}
