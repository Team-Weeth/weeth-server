...
enum class UserResponseCode(
    ...
    USER_EMAIL_CHECK_SUCCESS(1806, HttpStatus.OK, "이메일 중복 검사가 성공적으로 처리되었습니다."),
    USER_FIND_BY_ID_SUCCESS(1807, HttpStatus.OK, "회원 정보가 성공적으로 조회되었습니다."),
    USER_UPDATE_SUCCESS(1808, HttpStatus.OK, "회원 정보가 성공적으로 수정되었습니다."),
    USER_LEAVE_SUCCESS(1809, HttpStatus.OK, "회원 탈퇴가 성공적으로 처리되었습니다."),
    JWT_REFRESH_SUCCESS(1810, HttpStatus.OK, "토큰 재발급에 성공했습니다."),
    SOCIAL_LOGIN_SUCCESS(1811, HttpStatus.OK, "소셜 로그인이 성공적으로 처리되었습니다."),
}
