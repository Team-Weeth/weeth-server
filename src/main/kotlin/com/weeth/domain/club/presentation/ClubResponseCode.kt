...
enum class ClubResponseCode(
    ...
    LEAD_TRANSFERRED_SUCCESS(11117, HttpStatus.OK, "LEAD 권한이 이양되었습니다."),
    MEMBERSHIP_STATUS_FIND_SUCCESS(11118, HttpStatus.OK, "동아리 가입 상태를 성공적으로 조회했습니다."),
    MEMBER_SUMMARY_FIND_SUCCESS(11119, HttpStatus.OK, "내 요약 정보를 성공적으로 조회했습니다."),
