...
data class ClubUpdateRequest(
    ...
    @field:Schema(description = "프로필 사진 URL", example = "https://s3.amazonaws.com/bucket/profile.jpg")
    val profileImageUrl: String? = null,
    @field:Schema(description = "배경 사진 URL", example = "https://s3.amazonaws.com/bucket/background.jpg")
