...
enum class ClubErrorCode(
    ...
    @ExplainError("포지션 옵션을 동아리당 최대 개수(MAX_OPTION_COUNT)를 초과하여 저장하려 할 때 발생합니다.")
    POSITION_OPTION_LIMIT_EXCEEDED(
        21120,
        HttpStatus.BAD_REQUEST,
        "포지션 옵션은 최대 ${ClubPositionOption.MAX_OPTION_COUNT}개까지 설정할 수 있습니다.",
    ),
