...
enum class AttendanceResponseCode(
    ...
    ATTENDANCE_CHECKIN_SUCCESS(1203, HttpStatus.OK, "출석이 성공적으로 처리되었습니다."),
    ATTENDANCE_FIND_SUCCESS(1204, HttpStatus.OK, "사용자의 출석 정보가 성공적으로 조회되었습니다."),
    ATTENDANCE_FIND_ALL_SUCCESS(1205, HttpStatus.OK, "사용자의 상세 출석 정보가 성공적으로 조회되었습니다."),

    // QR 관련
    QR_TOKEN_GENERATE_SUCCESS(1206, HttpStatus.OK, "QR 코드가 성공적으로 생성되었습니다."),
}
