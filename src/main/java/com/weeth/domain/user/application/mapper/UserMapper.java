...
import static com.weeth.domain.user.application.dto.request.UserRequestDto.Register;
import static com.weeth.domain.user.application.dto.request.UserRequestDto.SignUp;
...
public interface UserMapper {
    ...
    @Mappings({
            ...
            @Mapping(target = "department", expression = "java( com.weeth.domain.user.domain.entity.enums.Department.to(dto.department()) )")
    })
