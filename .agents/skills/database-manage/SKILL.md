...
```
Read: .agents/skills/database-manage/references/schema.md
```
...
.agents/skills/database-manage/scripts/dump-schema.sh -h localhost -P 3306 -u root -p <password> -d weeth
```
